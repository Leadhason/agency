  ...
  return (
    <div className="py-12 sm:py-16 lg:py-20 px-4 sm:px-6">
        <div className="grid grid-cols-1 lg:grid-cols-2 p-2 sm:p-3 gap-8 sm:gap-10 lg:gap-14 mb-8">
            <div className="flex w-full rounded-3xl order-2 lg:order-1">
                <Image 
                    src="/training-2.jpeg"
                    alt=""
                    height={50}
            ...
            <div className="flex flex-col p-3 sm:p-4 lg:p-6 py-6 sm:py-8 lg:py-10 space-y-4 order-1 lg:order-2">
